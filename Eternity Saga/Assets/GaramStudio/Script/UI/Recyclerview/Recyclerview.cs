...
public delegate void CellViewVisibilityChangedDelegate(RecyclerCellView cellView);

/// <summary>
/// This delegate will be fired just before the cell view is recycled
/// </summary>
/// <param name="cellView"></param>
public delegate void CellViewWillRecycleDelegate(RecyclerCellView cellView);
...
public delegate void ScrollerScrolledDelegate(Recyclerview scroller, Vector2 val, float scrollPosition);
...
public delegate void ScrollerSnappedDelegate(Recyclerview scroller, int cellIndex, int dataIndex, RecyclerCellView cellView);
...
public delegate void ScrollerScrollingChangedDelegate(Recyclerview scroller, bool scrolling);
...
public delegate void ScrollerTweeningChangedDelegate(Recyclerview scroller, bool tweening);
...
public delegate void CellViewInstantiated(Recyclerview scroller, RecyclerCellView cellView);
...
public delegate void CellViewReused(Recyclerview scroller, RecyclerCellView cellView);

/// <summary>
/// The Recyclerview allows you to easily set up a dynamic scroller that will recycle views for you. This means
...
/// </summary>
public class Recyclerview : MonoBehaviour, IBeginDragHandler, IEndDragHandler
{
    #region Public
    ...
    /// </summary>
    public IRecyclerviewDelegate Delegate { get { return _delegate; } set { _delegate = value; _reloadData = true; } }
    ...
    public RecyclerCellView GetCellView(RecyclerCellView cellPrefab)
    {
        ...
        if (cellView == null)
        {
            ...
            cellView = go.GetComponent<RecyclerCellView>();
    ...
    /// <returns></returns>
    public RecyclerCellView GetCellViewAtDataIndex(int dataIndex)
    {
        for (var i = 0; i < _activeCellViews.Count; i++)
        {
    ...
    /// </summary>
    private IRecyclerviewDelegate _delegate;
    ...
    void OnValidate()
    {
        ...
        if (GetComponent<ScrollRect>() == null) throw new MissingComponentException("Missing ScrollRect component");
    }
    ...
    private void SnapJumpComplete()
    {
        ...
        RecyclerCellView cellView = null;
        for (var i = 0; i < _activeCellViews.Count; i++)
        {
